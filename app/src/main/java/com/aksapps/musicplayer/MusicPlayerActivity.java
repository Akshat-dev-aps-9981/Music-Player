...
public class MusicPlayerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentTimeTv.setTextColor(color);
        totalTimeTv.setTextColor(color);
    ...
    public static String convertToMMSS(String duration) {
        ...
        return String.format("%02d:%02d", TimeUnit.MILLISECONDS.toMinutes(millis) % TimeUnit.HOURS.toMinutes(1), TimeUnit.MILLISECONDS.toSeconds(
                millis
